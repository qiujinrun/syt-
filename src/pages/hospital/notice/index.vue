    ...
    <div class="notice">
        ...
        <div class="info">
            ...
            <div class="text">
                ...
                <br />在同一自然日，同一医院，同一科室，同一就诊单元，同一就诊人，可以预约最多1个号源；
                <br />在同一自然周，同一就诊人，可以预约最多8个号源；
                <br />在同一自然月，同一就诊人，可以预约最多12个号源；
                <br />在同一自然季度，同一就诊人，可以预约最多24个号源。
            </div>
        </div>
        <div class="info">
            <div class="tip">
        ...
        <div class="info">
            ...
            <div class="text">
                ...
                <br />累计爽约3次，自3次爽约日起，90天内不允许通过114平台进行预约挂号；
                <br />累计爽约6次，自6次爽约日起，180天内不允许通过114平台进行预约挂号。
            </div>
        </div>
    </div>
</template>
